...
Url: ${_getEventFilterUrl(event)}`
    ...
    function _getPossibleEventMessages(event) {
      ...
      if (event.exception) {
        ...
        try {
          const { type: type2 = "", value = "" } = values && values[values.length - 1] || {};
  ...
  "node_modules/@sentry/node/cjs/client.js"(exports) {
    ...
    var NodeClient = class extends core.BaseClient {
      ...
      _prepareEvent(event, hint, scope) {
        ...
        event.server_name = event.server_name || this.getOptions().serverName || global.process.env.SENTRY_NAME || os2.hostname();
    ...
    var LinkedErrors = class {
      ...
      setupOnce(addGlobalEventProcessor, getCurrentHub2) {
        addGlobalEventProcessor(async (event, hint) => {
          ...
          const contextLines = getCurrentHub2().getIntegration(contextlines.ContextLines);
          if (contextLines) {
